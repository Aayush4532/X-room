...
export default function Main() {
  return (
    <div className="bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] py-16 md:py-24 lg:py-32">
      <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="text-center md:text-left">
            <h1 className="block text-4xl sm:text-5xl lg:text-6xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-indigo-300 mb-6">
              Streamline interviews with{" "}
              <span className="block mt-2">X-Room</span>
            </h1>
            <p className="mt-3 text-xl text-gray-300 max-w-2xl">
              X-Room solves one of the biggest hiring inefficiencies: missed
              interviews. Automate invites, get confirmations, and focus on
              finding the right talent.
            </p>

            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              <a
                className="btn btn-primary px-8 py-4 text-lg font-semibold bg-gradient-to-r from-blue-500 to-indigo-600 border-none text-white hover:from-blue-600 hover:to-indigo-700 transition-all transform hover:-translate-y-1"
                href="/sign-up"
              >
                Get started
                <svg
                  className="shrink-0 size-5 ml-2"
              ...
              <a
                className="btn btn-outline px-8 py-4 text-lg font-semibold border-2 border-indigo-400 text-indigo-100 hover:bg-indigo-500/10 hover:text-white transition-all"
                href="#"
              >
                Contact sales team
              </a>
            ...
            <div className="mt-16 flex flex-wrap justify-center md:justify-start gap-10">
              <div className="text-left">
                ...
                <p className="text-gray-400 text-sm">
                  <span className="font-bold text-white">4.6</span> /5 - from 12k reviews
                </p>
                <div className="mt-4">
                  <svg
                    className="h-auto w-28 text-gray-200"
                    width="80"
                    height="27"
                    viewBox="0 0 80 27"
                    fill="none"
              ...
              <div className="text-left">
                ...
                <p className="text-gray-400 text-sm">
                  <span className="font-bold text-white">4.8</span> /5 - from 5k reviews
                </p>
                <div className="mt-4">
                  <svg
                    className="h-auto w-36 text-gray-200"
                    width="110"
                    height="28"
                    viewBox="0 0 110 28"
                    fill="none"
          ...
          <div className="relative flex justify-center">
            <div className="relative z-10 rounded-xl overflow-hidden shadow-2xl transform transition-all duration-500 hover:scale-[1.02]">
              <div className="bg-gradient-to-br from-indigo-500 to-blue-600 p-1 rounded-xl">
                <div className="bg-gray-900 rounded-lg overflow-hidden">
                  <img
                    className="w-full h-auto object-cover rounded-lg"
                    src="https://images.unsplash.com/photo-1551836022-d5d88e9218df?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1200&q=80"
                    alt="X-Room Dashboard"
                  />
                </div>
              </div>
            </div>
            
            <div className="absolute inset-0 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full filter blur-3xl opacity-20 -z-0"></div>
            
            <div className="absolute -bottom-8 -right-8 w-48 h-48 bg-blue-500 rounded-full filter blur-[100px] opacity-30 -z-0"></div>
            <div className="absolute -top-8 -left-8 w-48 h-48 bg-indigo-500 rounded-full filter blur-[100px] opacity-30 -z-0"></div>
          </div>
        </div>
      </div>
    </div>
